...
const IMGS = [
  ...
  'https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?w=700&q=80',
];
      ...
      <section className="section-padding">
        <div className="container about-inner-grid">
          ...
          <div className="about-imgs">
            {IMGS.map((src, i) => (
              <img key={i} src={src} alt="EL ASASS" className="about-img-item" style={{marginTop: i===1?'40px':0}} />
            ))}
          </div>
        </div>
      </section>
