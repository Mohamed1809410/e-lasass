...
// ✅ Alle Bilder: 100% Heavy Equipment
const catImages = {
  excavators: [
    'https://images.unsplash.com/photo-1580901368919-7738efb0f87e?w=700&q=80', // Excavator on job site
     ],
  loaders: [
    'https://images.unsplash.com/photo-1629807473015-41699c4471b5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d2hlZWwlMjBsb2FkZXJzfGVufDB8fDB8fHww', // Loader/excavator
      ],
  bulldozers: [
    'https://images.unsplash.com/photo-1630288214032-2c4cc2c080ca?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8QnVsbGRvemVyc3xlbnwwfHwwfHx8MA%3D%3D', // Bulldozer
     ],
  trucks: [
    'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=700&q=80', // Dump truck
      ],
  road: [
    'https://images.unsplash.com/photo-1591486085897-f433f05e7aed?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cm9hZCUyMGVxdWlwbWVudHxlbnwwfHwwfHx8MA%3D%3D',   // Road equipment
     ],
  industrial: [
    'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?w=700&q=80', // Crane / industrial
      ],
};
  ...
  return (
    <div style={{paddingTop:'90px'}}>
      ...
      <style>{`
        ...
        .cat-tabs { display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 56px; }
        .cat-tab {
          padding: 10px 24px; border: 2px solid var(--gray-border);
          border-radius: 4px; font-family: inherit; font-size: 0.95rem;
          color: var(--gray-mid); transition: all 0.3s; cursor: pointer; background: transparent;
        }
        ...
        .cat-content { display: grid; grid-template-columns: 1fr 1fr; gap: 60px; align-items: center; }
        .cat-imgs { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
