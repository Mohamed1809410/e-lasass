...
// ✅ Alle Bilder: echte Baumaschinen / Heavy Equipment
const HERO_IMAGE = 'https://images.unsplash.com/photo-1580901368919-7738efb0f87e?w=1600&q=80'; // Excavator on site

const ABOUT_IMAGE = 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80'; // Excavator close-up

function getCatImage(id) {
  const map = {
    excavators: 'https://images.unsplash.com/photo-1580901368919-7738efb0f87e?w=600&q=80',   // excavator
    loaders:    'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80',   // excavator/loader
    bulldozers: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600&q=80',   // bulldozer
    trucks:     'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=600&q=80',   // dump truck
    road:       'https://images.unsplash.com/photo-1545558014-8692077e9b5c?w=600&q=80',      // road construction
    industrial: 'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?w=600&q=80',   // crane/industrial
  };
    ...
    <>
      ...
      <section className="hero">
        <div className="hero-bg">
          <img src={HERO_IMAGE} alt="Heavy equipment" className="hero-img" />
        ...
        <div className="container">
          ...
          <div style={{textAlign:'center', marginTop:'48px'}}>
            <Link to="/equipment" className="btn-primary">
              {lang === 'ar' ? 'عرض جميع المعدات' : 'View All Equipment'} <ArrowIcon size={18}/>
            </Link>
          </div>
        </div>
      </section>
      ...
      <style>{`
        ...
        .hero-label {
          font-family: 'Inter', sans-serif; font-size: 0.85rem; letter-spacing: 5px;
        ...
        .hero-sub {
          font-size: clamp(1rem, 2vw, 1.3rem); color: rgba(255,255,255,0.8);
          margin-bottom: 40px; max-width: 560px; line-height: 1.7;
        }
        .hero-btns { display: flex; gap: 16px; flex-wrap: wrap; }
        .scroll-down {
          position: absolute; bottom: 32px; left: 50%; transform: translateX(-50%);
          color: rgba(255,255,255,0.5); z-index: 2; animation: bounce 2s infinite;
        }
        @keyframes bounce {
        ...
        .about-img-wrap img {
          ...
          border-radius: 2px; box-shadow: 20px 20px 0 var(--gold);
        }
        .about-badge {
        ...
        .stats-grid { display: grid; grid-template-columns: repeat(2,1fr); gap: 24px; margin-top: 40px; }
        .stat-item { border-right: 3px solid var(--gold); padding-right: 16px; }
        ...
        .equip-card {
          ...
          box-shadow: 0 4px 20px rgba(0,0,0,0.08); transition: transform 0.3s, box-shadow 0.3s; display: block;
        }
        ...
        .equip-link { display: inline-flex; align-items: center; gap: 6px; color: var(--gold); font-weight: 600; font-size: 0.9rem; }
