    ...
    <div style={{paddingTop:'90px'}}>
      ...
      {lightboxIdx !== null && (
        <div className="lightbox" onClick={() => setLightboxIdx(null)}>
          ...
          <img
            src={GALLERY_IMGS[lightboxIdx].src.replace('w=800','w=1200')}
            alt="Gallery"
      ...
      <style>{`
        ...
        .masonry-overlay {
          ...
          background: rgba(17,17,17,0); transition: background 0.3s;
          display: flex; align-items: center; justify-content: center;
        }
        .masonry-overlay span {
          font-size: 3rem; color: var(--gold); opacity: 0; transition: opacity 0.3s;
          font-weight: 300;
        }
        ...
        .lb-close {
          ...
          color: var(--white); z-index: 1; transition: color 0.3s;
        }
